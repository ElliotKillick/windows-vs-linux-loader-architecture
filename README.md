...
- Complaint #1: [Downloading Windows](https://www.microsoft.com/en-us/software-download/windows11)
  - I had to make an [entire project](https://github.com/ElliotKilick/Mido) to work around this Microsoft bloatware (stop wasting people's time, Microsoft)
