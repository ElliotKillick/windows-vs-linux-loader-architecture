...
This lock hierarchy differs from the Windows closest equiavelnts of `LdrpLoadCompleteEvent`/`LdrpLoaderLock` and `LdrpModuleDataTableLock` locks, where no hierarchy exists between them.
